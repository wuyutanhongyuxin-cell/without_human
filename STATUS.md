...
- Next loop task: `cailiao-final-005-paragraph-repair-flow` should implement the prompt-only/offline paragraph-level targeted repair API and minimal UI from `docs/FINAL_DELIVERY_PLAN.md`, with human acceptance, locked-paragraph safeguards, rollback, tests, docs, and Stage 2B external parent blockers still unchecked.
